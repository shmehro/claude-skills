...
description: Create distinctive, production-grade frontend interfaces using Microsoft Fluent 2 Design System tokens and guidelines. Use this skill when the user asks to build web components, pages, or applications.
---

This skill creates production-grade frontend interfaces grounded in the **Microsoft Fluent 2 Design System**. All designs must use official Fluent 2 tokens for color, typography, spacing, motion, and shape. Designs should feel native to the Microsoft/M365 ecosystem while still being visually distinctive and well-crafted.
...
### Brand Color Palette (Web — default)
...
For Microsoft Teams: primary brand is #5b5fc7
For Microsoft Office: primary brand is #d83b01
...
1. **Clarity** — Use hierarchy and space to guide the user's attention. Avoid visual noise.
...
- **Cards**: `colorNeutralBackground1` surface, `borderRadius2XLarge` (12px), subtle shadow using `colorNeutralShadowAmbient`.
...
- Use `fontFamilyBase` (Segoe UI) as the primary font — this is the correct Fluent font, not a creative choice
